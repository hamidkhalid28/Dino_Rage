...
public:
  ...
  RD_Composition( const RD_SpriteSheetPtr_t &spriteSheet, const TV_NodeTreeViewPtr_t &nodeTreeView, const TV_NodeTreeViewPtr_t &parentNodeTreeView );
  virtual ~RD_Composition();

  void build( float frame );
