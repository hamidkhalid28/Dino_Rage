...
namespace CnControls
{
    ...
    {
        [Flags]
        public enum JoystickMovementDirection
        {
            Horizontal = 0x1,
            Vertical = 0x2,
        ...
        public JoystickMovementDirection JoystickMoveAxis = JoystickMovementDirection.Both;
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            if ((JoystickMoveAxis & JoystickMovementDirection.Horizontal) == 0)
            {
                stickAnchoredPosition.x = _intermediateStickPosition.x;
            }
            if ((JoystickMoveAxis & JoystickMovementDirection.Vertical) == 0)
            {
            ...
            _horizintalAxis.Value = horizontalValue;
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            _horizintalAxis.Value = _verticalAxis.Value = 0f;
        ...
        private void Hide(bool isHidden)
        {
            if (isHidden)
            {
                Base.color = Stick.color = Color.clear;
            }
            else
            {
                Base.color = Stick.color = Color.white;
            }
        }
    }
}
